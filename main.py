...
def generate_latex_resume():
    ...
    # Define EDUCATIONS, EXPERIENCES, and PROJECTS as global variables
    global EDUCATIONS, EXPERIENCES, PROJECTS

    # You can define functions to collect education, experience, and project details here

    # Generate the LaTeX format resume
    latex_text = get_latex_text(heading, skills, EDUCATIONS, EXPERIENCES, PROJECTS)

    # Save LaTeX text to a .tex file
    with open("resume.tex", "w") as tex_file:
        tex_file.write(latex_text)

    print("Resume generated as 'resume.tex'")
...
generate_resume_button = Button(root, text="Generate LaTeX Resume", command=generate_latex_resume)
generate_resume_button.pack()
